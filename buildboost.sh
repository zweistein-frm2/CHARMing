...
./b2 link=static,shared cxxflags=-std=c++17  cflags=-fPIC address-model=64 --disable-icu boost.locale.icu=off boost.locale.iconv=on install $1 -sNO_LZMA=1 -sNO_ZLIB=1 -sNO_BZIP2=1 --prefix=$PWD/out
cd ..