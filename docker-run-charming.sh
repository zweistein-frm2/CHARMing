...
[ -z "$SSH_CLIENT" ] && docker run -it  --rm --net=host -e DISPLAY=$DISPLAY  -v /tmp/X11-unix:/tmp/.X11-unix -v /etc/charm:/etc/charm -v $HOME:/root/ --sysctl net.core.rmem_max=26214400 --ulimit rtprio=98  --cap-add=sys_nice charming-ubuntu18
