	...
	namespace Mpsd8 {
		...
		public:
			...
			Module():threshold(128),firmware(0x0102),
				tx_caps(Mcpd8::TX_CAP::POS_OR_AMP | Mcpd8::TX_CAP::TOF_POS_OR_AMP | Mcpd8::TX_CAP::TOF_POS_AND_AMP),
				tx_cap_setting(tx_cap_default),mode(Mode::Position){}
		};
		Mcpd8::TX_CAP Module::tx_cap_default = Mcpd8::TX_CAP::TOF_POS_OR_AMP;
